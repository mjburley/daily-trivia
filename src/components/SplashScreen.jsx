  ...
  const getIcon = (iconType) => {
    switch (iconType) {
      ...
      case 'paw':
        return (
          <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 10h.01M10 10h.01M12 14h.01M8.5 8a1.5 1.5 0 100-3 1.5 1.5 0 000 3zm7 0a1.5 1.5 0 100-3 1.5 1.5 0 000 3zM12 20c-4 0-6-2-6-4 0-1.5 1-3 3-4s3.5-.5 3-.5.5 0 3 .5 3 2.5 3 4c0 2-2 4-6 4z" />
          </svg>
        )
      case 'utensils':
        return (
