...
function ResultsScreen({ score, totalQuestions, onPlayAgain, quizTitle }) {
  ...
  const handleShare = async () => {
    const shareText = `I scored ${score}/${totalQuestions} (${percentage}%) on Daily Trivia: ${quizTitle}! Can you beat my score?`
  ...
  return (
    <div className="animate-bounce-in text-center">
      ...
      <div className="bg-cyber-dark/80 backdrop-blur-xl rounded-2xl border border-gray-800/50 shadow-2xl overflow-hidden p-8">
        ...
        {/* Quiz Title Badge */}
        <div className="mb-4">
          <span className="px-4 py-1 rounded-full bg-cyber-purple/20 text-cyber-purple-light text-sm font-medium">
            {quizTitle}
          </span>
        </div>
